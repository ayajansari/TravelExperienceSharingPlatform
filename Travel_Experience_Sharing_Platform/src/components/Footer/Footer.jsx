    ...
    return (
        <div className="  w-full bg-[#2f87fe]">
            ...
            <div className="flex flex-col md:items-center items-start py-8 px-8 md:m-4  " >
                ...
                <div className="" >
                    <input type="email" onChange={(e)=> setEmail(e.target.value)} placeholder="Your email address..." className="focus:outline-none py-2 px-3  mr-4 my-1 rounded-md w-72" />
                    <input type="button" onClick={handleNewsletter} value="Subscribe"   className= "text-[#2f87fe] hover:cursor-pointer font-bold bg-white py-2 px-4 rounded-md" />
                </div>
            </div>
